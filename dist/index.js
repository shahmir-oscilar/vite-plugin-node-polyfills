...
const v = (s, l) => c(s) === c(l), e = (s, l) => s ? s === !0 ? !0 : s === l : !1, w = (s) => s.startsWith("node:"), $ = (s) => {
  const l = s.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
  return new RegExp(`^${l}$`);
  ...
  }, p = Object.entries(j).reduce((o, [r, i]) => (!l.protocolImports && w(r) || h(r) || (o[r] = y(c(r)) || i), o), {}), f = B(import.meta.url), u = [
...
`);
  return {
    ...
    config(o, r) {
      const i = r.command === "serve", a = !!this?.meta?.rolldownVersion, m = {
      ...
      return {
        build: {
          rollupOptions: {
            ...
            ...Object.keys(g).length > 0 ? a ? { inject: g } : { plugins: [x(g)] } : {}
          }
        },
        ...a ? {} : {
          esbuild: {
